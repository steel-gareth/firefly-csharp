...
public abstract record class ParamsBase
{
    ...
    static ParamsBase()
    {
        ...
        var customHeadersEnv = Environment.GetEnvironmentVariable("FIREFLY_CUSTOM_HEADERS");
    ...
    static string GetUserAgent() => $"{typeof(FireflyClient).Name}/C# {GetPackageVersion()}";
