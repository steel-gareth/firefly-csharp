...
/// <inheritdoc/>
public sealed class FireflyClient : IFireflyClient
{
    ...
    readonly Lazy<IFireflyClientWithRawResponse> _withRawResponse;

    /// <inheritdoc/>
    public IFireflyClientWithRawResponse WithRawResponse
    {
        get { return _withRawResponse.Value; }
    }

    /// <inheritdoc/>
    public IFireflyClient WithOptions(Func<ClientOptions, ClientOptions> modifier)
    {
        return new FireflyClient(modifier(this._options));
    }
    ...
    public FireflyClient()
    {
        ...
        _withRawResponse = new(() => new FireflyClientWithRawResponse(this._options));
    ...
    public FireflyClient(ClientOptions options)
        : this()
    {
        _options = options;
    }
...
/// <inheritdoc/>
public sealed class FireflyClientWithRawResponse : IFireflyClientWithRawResponse
{
#if NET
    ...
    /// <inheritdoc/>
    public IFireflyClientWithRawResponse WithOptions(Func<ClientOptions, ClientOptions> modifier)
    {
        return new FireflyClientWithRawResponse(modifier(this._options));
    }
        ...
        where T : ParamsBase
    {
        ...
        while (true)
        {
            ...
            if (response != null && (++retries > maxRetries || !ShouldRetry(response)))
            {
                ...
                try
                {
                    throw FireflyExceptionFactory.CreateApiException(
                        response.StatusCode,
                ...
                {
                    throw new FireflyIOException("I/O Exception", e);
                }
                finally
                {
                    response.Dispose();
    ...
    {
        return e is IOException || e is FireflyIOException;
    }

    public void Dispose() => this.HttpClient.Dispose();

    public FireflyClientWithRawResponse()
    {
        _options = new();
    ...
    public FireflyClientWithRawResponse(ClientOptions options)
        : this()
    {
        _options = options;
    }
