...
/// </summary>
public record class AccountListTransactionsParams : ParamsBase
{
    ...
    public AccountListTransactionsParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AccountListTransactionsParams(
        AccountListTransactionsParams accountListTransactionsParams
    )
        : base(accountListTransactionsParams)
    {
        this.ID = accountListTransactionsParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static AccountListTransactionsParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(AccountListTransactionsParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v1/accounts/{0}/transactions", this.ID)
        )
        {
