...
/// </summary>
public record class BillListParams : ParamsBase
{
    /// <summary>
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BillListParams(BillListParams billListParams)
        : base(billListParams) { }
...
#pragma warning restore CS8618
    ...
    public static BillListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(BillListParams? other)
    {
        if (other == null)
        {
            return false;
