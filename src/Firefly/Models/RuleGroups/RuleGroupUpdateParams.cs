...
/// </summary>
public record class RuleGroupUpdateParams : ParamsBase
{
    ...
    public RuleGroupUpdateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public RuleGroupUpdateParams(RuleGroupUpdateParams ruleGroupUpdateParams)
        : base(ruleGroupUpdateParams)
    {
        this.ID = ruleGroupUpdateParams.ID;

        this._rawBodyData = new(ruleGroupUpdateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static RuleGroupUpdateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string id
    ...
    public virtual bool Equals(RuleGroupUpdateParams? other)
    {
        if (other == null)
        {
            return false;
