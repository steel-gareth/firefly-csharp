...
namespace Firefly.Models.Chart.Account;

/// <summary>
/// This endpoint returns the data required to generate a chart with basic asset account
/// balance information. This is used on the dashboard.
///
/// <para>NOTE: Do not inherit from this type outside the SDK unless you're okay with
/// breaking changes in non-major versions. We may add new methods in the future that
/// cause existing derived classes to break.</para>
/// </summary>
public record class AccountRetrieveOverviewParams : ParamsBase
{
    /// <summary>
    ...
    public AccountRetrieveOverviewParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AccountRetrieveOverviewParams(
        AccountRetrieveOverviewParams accountRetrieveOverviewParams
    )
        : base(accountRetrieveOverviewParams) { }
...
#pragma warning restore CS8618
    ...
    public static AccountRetrieveOverviewParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(AccountRetrieveOverviewParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/v1/chart/account/overview"
        )
        {
