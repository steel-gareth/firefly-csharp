...
namespace Firefly.Models.Categories;
...
/// </summary>
public record class CategoryListTransactionsParams : ParamsBase
{
    ...
    public CategoryListTransactionsParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CategoryListTransactionsParams(
        CategoryListTransactionsParams categoryListTransactionsParams
    )
        : base(categoryListTransactionsParams)
    {
        this.ID = categoryListTransactionsParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static CategoryListTransactionsParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(CategoryListTransactionsParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v1/categories/{0}/transactions", this.ID)
        )
        {
