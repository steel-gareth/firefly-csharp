...
/// </summary>
public record class ExchangeRateListParams : ParamsBase
{
    /// <summary>
    ...
    public ExchangeRateListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExchangeRateListParams(ExchangeRateListParams exchangeRateListParams)
        : base(exchangeRateListParams) { }
...
#pragma warning restore CS8618
    ...
    public static ExchangeRateListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ExchangeRateListParams? other)
    {
        if (other == null)
        {
            return false;
