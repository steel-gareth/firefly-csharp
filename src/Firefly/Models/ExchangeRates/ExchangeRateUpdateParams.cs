...
/// </summary>
public record class ExchangeRateUpdateParams : ParamsBase
{
    ...
    public string? To
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<string>("to");
        }
    ...
    public ExchangeRateUpdateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExchangeRateUpdateParams(ExchangeRateUpdateParams exchangeRateUpdateParams)
        : base(exchangeRateUpdateParams)
    {
        this.ID = exchangeRateUpdateParams.ID;

        this._rawBodyData = new(exchangeRateUpdateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static ExchangeRateUpdateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string id
    ...
    public virtual bool Equals(ExchangeRateUpdateParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v1/exchange-rates/{0}", this.ID)
        )
        {
