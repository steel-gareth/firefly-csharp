...
/// </summary>
public record class TransferListByTagParams : ParamsBase
{
    /// <summary>
    ...
    public TransferListByTagParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TransferListByTagParams(TransferListByTagParams transferListByTagParams)
        : base(transferListByTagParams) { }
...
#pragma warning restore CS8618
    ...
    public static TransferListByTagParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(TransferListByTagParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/insight/transfer/tag")
        {
