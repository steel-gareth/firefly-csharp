...
/// </summary>
public record class TransferListWithoutTagParams : ParamsBase
{
    /// <summary>
    ...
    public TransferListWithoutTagParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TransferListWithoutTagParams(TransferListWithoutTagParams transferListWithoutTagParams)
        : base(transferListWithoutTagParams) { }
...
#pragma warning restore CS8618
    ...
    public static TransferListWithoutTagParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(TransferListWithoutTagParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/v1/insight/transfer/no-tag"
        )
        {
