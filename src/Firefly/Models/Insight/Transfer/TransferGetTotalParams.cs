...
/// </summary>
public record class TransferGetTotalParams : ParamsBase
{
    /// <summary>
    ...
    public TransferGetTotalParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TransferGetTotalParams(TransferGetTotalParams transferGetTotalParams)
        : base(transferGetTotalParams) { }
...
#pragma warning restore CS8618
    ...
    public static TransferGetTotalParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(TransferGetTotalParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/v1/insight/transfer/total"
        )
        {
