...
/// </summary>
public record class TransferListWithoutCategoryParams : ParamsBase
{
    /// <summary>
    ...
    public TransferListWithoutCategoryParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TransferListWithoutCategoryParams(
        TransferListWithoutCategoryParams transferListWithoutCategoryParams
    )
        : base(transferListWithoutCategoryParams) { }
...
#pragma warning restore CS8618
    ...
    public static TransferListWithoutCategoryParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(TransferListWithoutCategoryParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/v1/insight/transfer/no-category"
        )
        {
