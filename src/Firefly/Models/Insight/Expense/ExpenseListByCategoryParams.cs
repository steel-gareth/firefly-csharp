...
/// </summary>
public record class ExpenseListByCategoryParams : ParamsBase
{
    /// <summary>
    ...
    public ExpenseListByCategoryParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExpenseListByCategoryParams(ExpenseListByCategoryParams expenseListByCategoryParams)
        : base(expenseListByCategoryParams) { }
...
#pragma warning restore CS8618
    ...
    public static ExpenseListByCategoryParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ExpenseListByCategoryParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/v1/insight/expense/category"
        )
        {
