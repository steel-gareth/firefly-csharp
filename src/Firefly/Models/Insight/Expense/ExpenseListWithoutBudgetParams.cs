...
/// </summary>
public record class ExpenseListWithoutBudgetParams : ParamsBase
{
    /// <summary>
    ...
    public ExpenseListWithoutBudgetParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExpenseListWithoutBudgetParams(
        ExpenseListWithoutBudgetParams expenseListWithoutBudgetParams
    )
        : base(expenseListWithoutBudgetParams) { }
...
#pragma warning restore CS8618
    ...
    public static ExpenseListWithoutBudgetParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ExpenseListWithoutBudgetParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/v1/insight/expense/no-budget"
        )
        {
