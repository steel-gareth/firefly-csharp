...
/// </summary>
public record class ExpenseListByExpenseAccountParams : ParamsBase
{
    /// <summary>
    ...
    /// of expense accounts, only those accounts are included in the results. If
    ...
    public ExpenseListByExpenseAccountParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExpenseListByExpenseAccountParams(
        ExpenseListByExpenseAccountParams expenseListByExpenseAccountParams
    )
        : base(expenseListByExpenseAccountParams) { }
...
#pragma warning restore CS8618
    ...
    public static ExpenseListByExpenseAccountParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ExpenseListByExpenseAccountParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/v1/insight/expense/expense"
        )
        {
