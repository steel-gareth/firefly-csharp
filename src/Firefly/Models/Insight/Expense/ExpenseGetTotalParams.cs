...
/// </summary>
public record class ExpenseGetTotalParams : ParamsBase
{
    /// <summary>
    ...
    public ExpenseGetTotalParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExpenseGetTotalParams(ExpenseGetTotalParams expenseGetTotalParams)
        : base(expenseGetTotalParams) { }
...
#pragma warning restore CS8618
    ...
    public static ExpenseGetTotalParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ExpenseGetTotalParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/insight/expense/total")
        {
