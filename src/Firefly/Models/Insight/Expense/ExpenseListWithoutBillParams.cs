...
/// </summary>
public record class ExpenseListWithoutBillParams : ParamsBase
{
    /// <summary>
    ...
    public ExpenseListWithoutBillParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExpenseListWithoutBillParams(ExpenseListWithoutBillParams expenseListWithoutBillParams)
        : base(expenseListWithoutBillParams) { }
...
#pragma warning restore CS8618
    ...
    public static ExpenseListWithoutBillParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ExpenseListWithoutBillParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/v1/insight/expense/no-bill"
        )
        {
