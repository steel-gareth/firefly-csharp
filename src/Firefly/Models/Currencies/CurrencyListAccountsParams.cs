...
/// </summary>
public record class CurrencyListAccountsParams : ParamsBase
{
    ...
    public CurrencyListAccountsParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CurrencyListAccountsParams(CurrencyListAccountsParams currencyListAccountsParams)
        : base(currencyListAccountsParams)
    {
        this.Code = currencyListAccountsParams.Code;
    }
...
#pragma warning restore CS8618
    ...
    public static CurrencyListAccountsParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string code
    )
    ...
    public virtual bool Equals(CurrencyListAccountsParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v1/currencies/{0}/accounts", this.Code)
        )
        {
