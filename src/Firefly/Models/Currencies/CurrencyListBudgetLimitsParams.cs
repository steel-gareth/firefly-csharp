...
namespace Firefly.Models.Currencies;
...
/// </summary>
public record class CurrencyListBudgetLimitsParams : ParamsBase
{
    ...
    public CurrencyListBudgetLimitsParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CurrencyListBudgetLimitsParams(
        CurrencyListBudgetLimitsParams currencyListBudgetLimitsParams
    )
        : base(currencyListBudgetLimitsParams)
    {
        this.Code = currencyListBudgetLimitsParams.Code;
    }
...
#pragma warning restore CS8618
    ...
    public static CurrencyListBudgetLimitsParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string code
    )
    ...
    public virtual bool Equals(CurrencyListBudgetLimitsParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v1/currencies/{0}/budget-limits", this.Code)
        )
        {
