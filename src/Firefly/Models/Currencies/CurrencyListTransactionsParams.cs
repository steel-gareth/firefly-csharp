...
/// </summary>
public record class CurrencyListTransactionsParams : ParamsBase
{
    ...
    public CurrencyListTransactionsParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CurrencyListTransactionsParams(
        CurrencyListTransactionsParams currencyListTransactionsParams
    )
        : base(currencyListTransactionsParams)
    {
        this.Code = currencyListTransactionsParams.Code;
    }
...
#pragma warning restore CS8618
    ...
    public static CurrencyListTransactionsParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string code
    )
    ...
    public virtual bool Equals(CurrencyListTransactionsParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v1/currencies/{0}/transactions", this.Code)
        )
        {
