...
/// <summary>
/// List all transactions created by a recurring transaction, optionally limited
/// to the date ranges specified.
///
/// <para>NOTE: Do not inherit from this type outside the SDK unless you're okay with
/// breaking changes in non-major versions. We may add new methods in the future that
/// cause existing derived classes to break.</para>
/// </summary>
public record class RecurrenceListTransactionsParams : ParamsBase
{
    ...
    public RecurrenceListTransactionsParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public RecurrenceListTransactionsParams(
        RecurrenceListTransactionsParams recurrenceListTransactionsParams
    )
        : base(recurrenceListTransactionsParams)
    {
        this.ID = recurrenceListTransactionsParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static RecurrenceListTransactionsParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(RecurrenceListTransactionsParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v1/recurrences/{0}/transactions", this.ID)
        )
        {
