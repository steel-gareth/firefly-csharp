...
public record class RuleCreateParams : ParamsBase
{
    ...
    public required IReadOnlyList<global::Firefly.Models.Rules.Action> Actions
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullStruct<
                ImmutableArray<global::Firefly.Models.Rules.Action>
            >("actions");
        }
        init
        {
            this._rawBodyData.Set<ImmutableArray<global::Firefly.Models.Rules.Action>>(
                "actions",
...
[JsonConverter(typeof(JsonModelConverter<global::Firefly.Models.Rules.Action, ActionFromRaw>))]
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public Action(global::Firefly.Models.Rules.Action action)
        : base(action) { }
#pragma warning restore CS8618
...
#pragma warning restore CS8618
    ...
    public static global::Firefly.Models.Rules.Action FromRawUnchecked(
...
class ActionFromRaw : IFromRawJson<global::Firefly.Models.Rules.Action>
{
    /// <inheritdoc/>
    public global::Firefly.Models.Rules.Action FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => global::Firefly.Models.Rules.Action.FromRawUnchecked(rawData);
}
