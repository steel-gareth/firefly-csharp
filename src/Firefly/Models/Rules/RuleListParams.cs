...
/// </summary>
public record class RuleListParams : ParamsBase
{
    /// <summary>
    ...
    public RuleListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public RuleListParams(RuleListParams ruleListParams)
        : base(ruleListParams) { }
...
#pragma warning restore CS8618
    ...
    public static RuleListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(RuleListParams? other)
    {
        if (other == null)
        {
            return false;
