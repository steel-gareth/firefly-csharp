...
/// </summary>
public record class BudgetRetrieveParams : ParamsBase
{
    ...
    public BudgetRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BudgetRetrieveParams(BudgetRetrieveParams budgetRetrieveParams)
        : base(budgetRetrieveParams)
    {
        this.ID = budgetRetrieveParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static BudgetRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(BudgetRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
