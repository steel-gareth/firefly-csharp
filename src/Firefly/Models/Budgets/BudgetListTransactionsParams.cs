...
/// </summary>
public record class BudgetListTransactionsParams : ParamsBase
{
    ...
    public BudgetListTransactionsParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BudgetListTransactionsParams(BudgetListTransactionsParams budgetListTransactionsParams)
        : base(budgetListTransactionsParams)
    {
        this.ID = budgetListTransactionsParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static BudgetListTransactionsParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(BudgetListTransactionsParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v1/budgets/{0}/transactions", this.ID)
        )
        {
