...
public sealed class TagService : ITagService
{
    ...
    public TagService(IFireflyClient client)
    {
        _client = client;
...
public sealed class TagServiceWithRawResponse : ITagServiceWithRawResponse
{
    ...
    public TagServiceWithRawResponse(IFireflyClientWithRawResponse client)
    {
        _client = client;
    }
    ...
    )
    {
        ...
        {
            throw new FireflyInvalidDataException("'parameters.Tag' cannot be null");
        }
