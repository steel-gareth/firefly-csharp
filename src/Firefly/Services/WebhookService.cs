...
public sealed class WebhookService : IWebhookService
{
    ...
    public WebhookService(IFireflyClient client)
    {
        _client = client;
...
public sealed class WebhookServiceWithRawResponse : IWebhookServiceWithRawResponse
{
    ...
    public WebhookServiceWithRawResponse(IFireflyClientWithRawResponse client)
    {
        _client = client;
    ...
    )
    {
        ...
        {
            throw new FireflyInvalidDataException("'parameters.TransactionID' cannot be null");
        }
