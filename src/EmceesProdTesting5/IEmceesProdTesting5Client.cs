...
/// <summary>
/// A client for interacting with the Emcees Prod Testing 5 REST API.
///
...
/// </summary>
public interface IEmceesProdTesting5Client : IDisposable
{
    ...
    /// for each method.
    /// </summary>
    IEmceesProdTesting5ClientWithRawResponse WithRawResponse { get; }
    ...
    /// </summary>
    IEmceesProdTesting5Client WithOptions(Func<ClientOptions, ClientOptions> modifier);
...
/// <summary>
/// A view of <see cref="IEmceesProdTesting5Client"/> that provides access to raw HTTP responses for each method.
/// </summary>
public interface IEmceesProdTesting5ClientWithRawResponse : IDisposable
{
    /// <inheritdoc cref="ClientOptions.HttpClient" />
    HttpClient HttpClient { get; init; }
    ...
    /// <para>The original service is not modified.</para>
    /// </summary>
    IEmceesProdTesting5ClientWithRawResponse WithOptions(
    ...
    /// <summary>
    /// Sends a request to the Emcees Prod Testing 5 REST API.
    /// </summary>
