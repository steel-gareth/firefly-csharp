...
public sealed class LimitService : ILimitService
{
    ...
    public LimitService(IEmceesProdTesting5Client client)
    {
        _client = client;
...
public sealed class LimitServiceWithRawResponse : ILimitServiceWithRawResponse
{
    ...
    public LimitServiceWithRawResponse(IEmceesProdTesting5ClientWithRawResponse client)
    {
        _client = client;
    }
    ...
    )
    {
        ...
        {
            throw new EmceesProdTesting5InvalidDataException("'parameters.LimitID' cannot be null");
        }
