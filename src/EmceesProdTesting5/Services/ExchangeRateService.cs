...
public sealed class ExchangeRateService : IExchangeRateService
{
    ...
    public ExchangeRateService(IEmceesProdTesting5Client client)
    {
        _client = client;
...
public sealed class ExchangeRateServiceWithRawResponse : IExchangeRateServiceWithRawResponse
{
    ...
    public ExchangeRateServiceWithRawResponse(IEmceesProdTesting5ClientWithRawResponse client)
    {
        _client = client;
    }
    ...
    )
    {
        ...
        {
            throw new EmceesProdTesting5InvalidDataException("'parameters.To' cannot be null");
        }
    ...
    )
    {
        ...
        {
            throw new EmceesProdTesting5InvalidDataException("'parameters.Date' cannot be null");
        }
