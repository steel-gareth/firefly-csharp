...
namespace EmceesProdTesting5.Services.Webhooks.Messages;
...
public sealed class AttemptService : IAttemptService
{
    ...
    public AttemptService(IEmceesProdTesting5Client client)
    {
        _client = client;
...
public sealed class AttemptServiceWithRawResponse : IAttemptServiceWithRawResponse
{
    ...
    public AttemptServiceWithRawResponse(IEmceesProdTesting5ClientWithRawResponse client)
    {
        _client = client;
    }
    ...
    )
    {
        if (parameters.AttemptID == null)
        {
            throw new EmceesProdTesting5InvalidDataException(
                "'parameters.AttemptID' cannot be null"
            );
        }
