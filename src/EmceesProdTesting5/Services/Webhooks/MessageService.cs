...
using EmceesProdTesting5.Services.Webhooks.Messages;

namespace EmceesProdTesting5.Services.Webhooks;
...
public sealed class MessageService : IMessageService
{
    ...
    public MessageService(IEmceesProdTesting5Client client)
    {
        _client = client;
...
public sealed class MessageServiceWithRawResponse : IMessageServiceWithRawResponse
{
    ...
    public MessageServiceWithRawResponse(IEmceesProdTesting5ClientWithRawResponse client)
    {
        _client = client;
