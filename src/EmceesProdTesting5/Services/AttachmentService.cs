...
public sealed class AttachmentService : IAttachmentService
{
    ...
    public AttachmentService(IEmceesProdTesting5Client client)
    {
        _client = client;
...
public sealed class AttachmentServiceWithRawResponse : IAttachmentServiceWithRawResponse
{
    ...
    public AttachmentServiceWithRawResponse(IEmceesProdTesting5ClientWithRawResponse client)
    {
        _client = client;
    }
    ...
    )
    {
        ...
        {
            throw new EmceesProdTesting5InvalidDataException("'parameters.Body' cannot be null");
        }
