...
using Chart = EmceesProdTesting5.Services.Chart;
...
public sealed class ChartService : IChartService
{
    ...
    public ChartService(IEmceesProdTesting5Client client)
    {
        _client = client;
...
public sealed class ChartServiceWithRawResponse : IChartServiceWithRawResponse
{
    ...
    public ChartServiceWithRawResponse(IEmceesProdTesting5ClientWithRawResponse client)
    {
        _client = client;
