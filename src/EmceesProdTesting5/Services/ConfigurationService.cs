...
public sealed class ConfigurationService : IConfigurationService
{
    ...
    public ConfigurationService(IEmceesProdTesting5Client client)
    {
        _client = client;
...
public sealed class ConfigurationServiceWithRawResponse : IConfigurationServiceWithRawResponse
{
    ...
    public ConfigurationServiceWithRawResponse(IEmceesProdTesting5ClientWithRawResponse client)
    {
        _client = client;
    }
    ...
    )
    {
        ...
        {
            throw new EmceesProdTesting5InvalidDataException("'parameters.Name' cannot be null");
        }
