...
using EmceesProdTesting5.Services.Insight;
...
public sealed class InsightService : IInsightService
{
    ...
    public InsightService(IEmceesProdTesting5Client client)
    {
        _client = client;
...
public sealed class InsightServiceWithRawResponse : IInsightServiceWithRawResponse
{
    ...
    public InsightServiceWithRawResponse(IEmceesProdTesting5ClientWithRawResponse client)
    {
        _client = client;
