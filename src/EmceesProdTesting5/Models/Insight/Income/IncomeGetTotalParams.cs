...
/// </summary>
public record class IncomeGetTotalParams : ParamsBase
{
    /// <summary>
    ...
    public IncomeGetTotalParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public IncomeGetTotalParams(IncomeGetTotalParams incomeGetTotalParams)
        : base(incomeGetTotalParams) { }
...
#pragma warning restore CS8618
    ...
    public static IncomeGetTotalParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(IncomeGetTotalParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/insight/income/total")
        {
