...
/// </summary>
public record class IncomeListByAssetAccountParams : ParamsBase
{
    /// <summary>
    ...
    public IncomeListByAssetAccountParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public IncomeListByAssetAccountParams(
        IncomeListByAssetAccountParams incomeListByAssetAccountParams
    )
        : base(incomeListByAssetAccountParams) { }
...
#pragma warning restore CS8618
    ...
    public static IncomeListByAssetAccountParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(IncomeListByAssetAccountParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/insight/income/asset")
        {
