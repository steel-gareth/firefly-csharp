...
/// </summary>
public record class IncomeListWithoutTagParams : ParamsBase
{
    /// <summary>
    ...
    public IncomeListWithoutTagParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public IncomeListWithoutTagParams(IncomeListWithoutTagParams incomeListWithoutTagParams)
        : base(incomeListWithoutTagParams) { }
...
#pragma warning restore CS8618
    ...
    public static IncomeListWithoutTagParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(IncomeListWithoutTagParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/insight/income/no-tag")
        {
