...
/// </summary>
public record class IncomeListWithoutCategoryParams : ParamsBase
{
    /// <summary>
    ...
    public IncomeListWithoutCategoryParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public IncomeListWithoutCategoryParams(
        IncomeListWithoutCategoryParams incomeListWithoutCategoryParams
    )
        : base(incomeListWithoutCategoryParams) { }
...
#pragma warning restore CS8618
    ...
    public static IncomeListWithoutCategoryParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(IncomeListWithoutCategoryParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/v1/insight/income/no-category"
        )
        {
