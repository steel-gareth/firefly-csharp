...
namespace EmceesProdTesting5.Models.Insight.Income;
...
/// </summary>
public record class IncomeListByCategoryParams : ParamsBase
{
    /// <summary>
    ...
    public IncomeListByCategoryParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public IncomeListByCategoryParams(IncomeListByCategoryParams incomeListByCategoryParams)
        : base(incomeListByCategoryParams) { }
...
#pragma warning restore CS8618
    ...
    public static IncomeListByCategoryParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(IncomeListByCategoryParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/v1/insight/income/category"
        )
        {
