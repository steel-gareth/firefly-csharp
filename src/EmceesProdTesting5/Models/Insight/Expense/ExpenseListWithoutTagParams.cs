...
/// </summary>
public record class ExpenseListWithoutTagParams : ParamsBase
{
    /// <summary>
    ...
    public ExpenseListWithoutTagParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExpenseListWithoutTagParams(ExpenseListWithoutTagParams expenseListWithoutTagParams)
        : base(expenseListWithoutTagParams) { }
...
#pragma warning restore CS8618
    ...
    public static ExpenseListWithoutTagParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ExpenseListWithoutTagParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/v1/insight/expense/no-tag"
        )
        {
