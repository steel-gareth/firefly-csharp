...
/// </summary>
public record class ExpenseListByAssetAccountParams : ParamsBase
{
    /// <summary>
    ...
    public ExpenseListByAssetAccountParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExpenseListByAssetAccountParams(
        ExpenseListByAssetAccountParams expenseListByAssetAccountParams
    )
        : base(expenseListByAssetAccountParams) { }
...
#pragma warning restore CS8618
    ...
    public static ExpenseListByAssetAccountParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ExpenseListByAssetAccountParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/insight/expense/asset")
        {
