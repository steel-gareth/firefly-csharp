...
/// </summary>
public record class ExpenseListByTagParams : ParamsBase
{
    /// <summary>
    ...
    public ExpenseListByTagParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExpenseListByTagParams(ExpenseListByTagParams expenseListByTagParams)
        : base(expenseListByTagParams) { }
...
#pragma warning restore CS8618
    ...
    public static ExpenseListByTagParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ExpenseListByTagParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/insight/expense/tag")
        {
