...
/// </summary>
public record class ExpenseListByBudgetParams : ParamsBase
{
    /// <summary>
    ...
    /// </summary>
    public IReadOnlyList<long>? Budgets
    {
        get
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableStruct<ImmutableArray<long>>("budgets");
        }
        init
        {
            if (value == null)
    ...
    public ExpenseListByBudgetParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExpenseListByBudgetParams(ExpenseListByBudgetParams expenseListByBudgetParams)
        : base(expenseListByBudgetParams) { }
...
#pragma warning restore CS8618
    ...
    public static ExpenseListByBudgetParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ExpenseListByBudgetParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/v1/insight/expense/budget"
        )
        {
