...
/// </summary>
public record class ExpenseListByBillParams : ParamsBase
{
    /// <summary>
    ...
    /// </summary>
    public IReadOnlyList<long>? Bills
    {
        get
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableStruct<ImmutableArray<long>>("bills");
        }
        init
        {
            if (value == null)
    ...
    public ExpenseListByBillParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExpenseListByBillParams(ExpenseListByBillParams expenseListByBillParams)
        : base(expenseListByBillParams) { }
...
#pragma warning restore CS8618
    ...
    public static ExpenseListByBillParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ExpenseListByBillParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/insight/expense/bill")
        {
