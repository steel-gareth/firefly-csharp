...
/// </summary>
public record class RuleGroupCreateParams : ParamsBase
{
    ...
    public RuleGroupCreateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public RuleGroupCreateParams(RuleGroupCreateParams ruleGroupCreateParams)
        : base(ruleGroupCreateParams)
    {
        this._rawBodyData = new(ruleGroupCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static RuleGroupCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(RuleGroupCreateParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/rule-groups")
        {
