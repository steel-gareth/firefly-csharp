...
namespace EmceesProdTesting5.Models.Transactions;
...
/// </summary>
public record class TransactionUpdateParams : ParamsBase
{
    ...
    public IReadOnlyList<TransactionUpdateParamsTransaction>? Transactions
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableStruct<
                ImmutableArray<TransactionUpdateParamsTransaction>
            >("transactions");
        }
        init
        {
            ...
            this._rawBodyData.Set<ImmutableArray<TransactionUpdateParamsTransaction>?>(
                "transactions",
    ...
    public TransactionUpdateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TransactionUpdateParams(TransactionUpdateParams transactionUpdateParams)
        : base(transactionUpdateParams)
    {
        this.ID = transactionUpdateParams.ID;

        this._rawBodyData = new(transactionUpdateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static TransactionUpdateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string id
    ...
    public virtual bool Equals(TransactionUpdateParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + string.Format("/v1/transactions/{0}", this.ID)
        )
        {
...
[JsonConverter(
    typeof(JsonModelConverter<
        TransactionUpdateParamsTransaction,
        TransactionUpdateParamsTransactionFromRaw
    >)
)]
public sealed record class TransactionUpdateParamsTransaction : JsonModel
{
    /// <summary>
    ...
    public ApiEnum<string, TransactionTypeProperty>? Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<ApiEnum<string, TransactionTypeProperty>>("type");
        }
        init
        {
            if (value == null)
    ...
    public TransactionUpdateParamsTransaction() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TransactionUpdateParamsTransaction(
        TransactionUpdateParamsTransaction transactionUpdateParamsTransaction
    )
        : base(transactionUpdateParamsTransaction) { }
#pragma warning restore CS8618

    public TransactionUpdateParamsTransaction(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    TransactionUpdateParamsTransaction(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="TransactionUpdateParamsTransactionFromRaw.FromRawUnchecked"/>
    public static TransactionUpdateParamsTransaction FromRawUnchecked(
...
class TransactionUpdateParamsTransactionFromRaw : IFromRawJson<TransactionUpdateParamsTransaction>
{
    /// <inheritdoc/>
    public TransactionUpdateParamsTransaction FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => TransactionUpdateParamsTransaction.FromRawUnchecked(rawData);
}
