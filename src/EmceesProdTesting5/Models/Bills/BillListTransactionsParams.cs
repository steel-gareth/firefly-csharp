...
/// </summary>
public record class BillListTransactionsParams : ParamsBase
{
    ...
    public BillListTransactionsParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BillListTransactionsParams(BillListTransactionsParams billListTransactionsParams)
        : base(billListTransactionsParams)
    {
        this.ID = billListTransactionsParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static BillListTransactionsParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(BillListTransactionsParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v1/bills/{0}/transactions", this.ID)
        )
        {
