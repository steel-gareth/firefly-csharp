...
/// <summary>
/// When a webhook is triggered the actual message that will be send is stored in
/// a "message". You can view and analyse these messages.
///
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v1/webhooks/{0}/messages", this.ID)
        )
        {
