...
/// <summary>
/// A client for interacting with the More Conflicting REST API.
///
...
/// </summary>
public interface IMoreConflictingClient : IDisposable
{
    ...
    /// for each method.
    /// </summary>
    IMoreConflictingClientWithRawResponse WithRawResponse { get; }
    ...
    /// </summary>
    IMoreConflictingClient WithOptions(Func<ClientOptions, ClientOptions> modifier);
...
/// <summary>
/// A view of <see cref="IMoreConflictingClient"/> that provides access to raw HTTP responses for each method.
/// </summary>
public interface IMoreConflictingClientWithRawResponse : IDisposable
{
    /// <inheritdoc cref="ClientOptions.HttpClient" />
    HttpClient HttpClient { get; init; }
    ...
    /// <para>The original service is not modified.</para>
    /// </summary>
    IMoreConflictingClientWithRawResponse WithOptions(Func<ClientOptions, ClientOptions> modifier);

    IPetServiceWithRawResponse Pets { get; }
    ...
    /// <summary>
    /// Sends a request to the More Conflicting REST API.
    /// </summary>
