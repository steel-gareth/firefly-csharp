...
public class RuleTestParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new RuleTestParams
        {
            ID = "123",
            Accounts = [1, 2, 3],
            End = "2026-04-30",
    ...
    {
        var parameters = new RuleTestParams { ID = "123" };
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://demo.firefly-iii.org/api/v1/rules/123/test?accounts=1%2c2%2c3&end=2026-04-30&start=2026-04-01"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        RuleTestParams copied = new(parameters);
