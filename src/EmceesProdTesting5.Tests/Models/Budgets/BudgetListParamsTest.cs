...
public class BudgetListParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new BudgetListParams
        {
            End = "2026-04-30",
            Limit = 10,
            Page = 1,
    ...
    {
        BudgetListParams parameters = new()
        {
            End = "2026-04-30",
            Limit = 10,
            Page = 1,
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://demo.firefly-iii.org/api/v1/budgets?end=2026-04-30&limit=10&page=1&start=2026-04-01"
                ),
                url
            )
        );
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        BudgetListParams parameters = new() { XTraceID = "40c71bbb-c676-4f24-83cf-cc725d7d7a00" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BudgetListParams copied = new(parameters);
