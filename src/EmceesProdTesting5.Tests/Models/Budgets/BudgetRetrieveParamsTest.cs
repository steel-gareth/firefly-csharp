...
public class BudgetRetrieveParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new BudgetRetrieveParams
        {
            ID = "123",
            End = "2026-04-30",
            Start = "2026-04-01",
    ...
    {
        var parameters = new BudgetRetrieveParams { ID = "123" };
    ...
    {
        BudgetRetrieveParams parameters = new()
        {
            ID = "123",
            End = "2026-04-30",
            Start = "2026-04-01",
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://demo.firefly-iii.org/api/v1/budgets/123?end=2026-04-30&start=2026-04-01"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        BudgetRetrieveParams copied = new(parameters);
