...
public class BudgetUpdateParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new BudgetUpdateParams
        {
            ID = "123",
            Name = "Bills",
            Active = false,
    ...
    {
        BudgetUpdateParams parameters = new() { ID = "123", Name = "Bills" };
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        BudgetUpdateParams parameters = new()
        {
            ID = "123",
            Name = "Bills",
            XTraceID = "40c71bbb-c676-4f24-83cf-cc725d7d7a00",
    ...
    public void CopyConstructor_Works()
    {
        ...
        BudgetUpdateParams copied = new(parameters);
