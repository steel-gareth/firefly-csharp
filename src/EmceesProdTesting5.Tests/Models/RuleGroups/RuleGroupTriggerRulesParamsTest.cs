...
public class RuleGroupTriggerRulesParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new RuleGroupTriggerRulesParams
        {
            ID = "123",
            Accounts = [1, 2, 3],
            End = "2026-04-30",
    ...
    {
        var parameters = new RuleGroupTriggerRulesParams { ID = "123" };
    ...
    {
        RuleGroupTriggerRulesParams parameters = new()
        {
            ID = "123",
            Accounts = [1, 2, 3],
            End = "2026-04-30",
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://demo.firefly-iii.org/api/v1/rule-groups/123/trigger?accounts=1%2c2%2c3&end=2026-04-30&start=2026-04-01"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        RuleGroupTriggerRulesParams copied = new(parameters);
