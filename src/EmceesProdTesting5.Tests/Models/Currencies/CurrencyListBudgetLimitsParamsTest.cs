...
public class CurrencyListBudgetLimitsParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new CurrencyListBudgetLimitsParams
        {
            Code = "USD",
            End = "2026-04-30",
            Limit = 10,
    ...
    {
        var parameters = new CurrencyListBudgetLimitsParams { Code = "USD" };
    ...
    {
        CurrencyListBudgetLimitsParams parameters = new()
        {
            Code = "USD",
            End = "2026-04-30",
            Limit = 10,
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://demo.firefly-iii.org/api/v1/currencies/USD/budget-limits?end=2026-04-30&limit=10&page=1&start=2026-04-01"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CurrencyListBudgetLimitsParams copied = new(parameters);
