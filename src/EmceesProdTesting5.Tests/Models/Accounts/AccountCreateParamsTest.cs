...
public class AccountCreateParamsTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        Assert.Equal(expectedLiabilityDirection, parameters.LiabilityDirection);
    ...
    public void OptionalNullableParamsUnsetAreNotSet_Works()
    {
        ...
        Assert.Null(parameters.LiabilityDirection);
        Assert.False(parameters.RawBodyData.ContainsKey("liability_direction"));
    ...
    public void OptionalNullableParamsSetToNullAreSetToNull_Works()
    {
        ...
        Assert.Null(parameters.LiabilityDirection);
        Assert.True(parameters.RawBodyData.ContainsKey("liability_direction"));
        Assert.Null(parameters.LiabilityType);
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(new Uri("https://demo.firefly-iii.org/api/v1/accounts"), url)
        );
    }
