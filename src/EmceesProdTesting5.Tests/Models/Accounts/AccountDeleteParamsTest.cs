...
public class AccountDeleteParamsTest : TestBase
{
    ...
    {
        var parameters = new AccountDeleteParams
        {
            ID = "123",
    ...
    {
        var parameters = new AccountDeleteParams { ID = "123" };
    ...
    {
        AccountDeleteParams parameters = new() { ID = "123" };
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        AccountDeleteParams parameters = new()
        {
            ID = "123",
            XTraceID = "40c71bbb-c676-4f24-83cf-cc725d7d7a00",
        };
