...
public class CategoryRetrieveParamsTest : TestBase
{
    ...
    {
        var parameters = new CategoryRetrieveParams { ID = "123" };
    ...
    {
        CategoryRetrieveParams parameters = new()
        {
            ID = "123",
            End = "2026-04-30",
            Start = "2026-04-01",
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://demo.firefly-iii.org/api/v1/categories/123?end=2026-04-30&start=2026-04-01"
                ),
                url
            )
        );
