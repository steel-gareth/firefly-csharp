...
public class AttemptDeleteParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new AttemptDeleteParams
        {
            ID = "123",
            MessageID = 1,
            AttemptID = 1,
    ...
    {
        AttemptDeleteParams parameters = new()
        {
            ID = "123",
            MessageID = 1,
            AttemptID = 1,
    ...
    public void CopyConstructor_Works()
    {
        ...
        AttemptDeleteParams copied = new(parameters);
