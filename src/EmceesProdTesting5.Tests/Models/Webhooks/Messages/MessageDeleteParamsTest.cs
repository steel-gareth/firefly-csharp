...
public class MessageDeleteParamsTest : TestBase
{
    ...
    {
        var parameters = new MessageDeleteParams
        {
            ID = "123",
            MessageID = 1,
    ...
    {
        var parameters = new MessageDeleteParams { ID = "123", MessageID = 1 };
    ...
    {
        MessageDeleteParams parameters = new() { ID = "123", MessageID = 1 };
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        MessageDeleteParams parameters = new()
        {
            ID = "123",
            MessageID = 1,
            XTraceID = "40c71bbb-c676-4f24-83cf-cc725d7d7a00",
