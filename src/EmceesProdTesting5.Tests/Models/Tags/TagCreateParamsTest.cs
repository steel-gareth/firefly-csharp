...
public class TagCreateParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new TagCreateParams
        {
            Tag = "expensive",
            Date = "2026-04-01",
    ...
    {
        TagCreateParams parameters = new() { Tag = "expensive" };

        var url = parameters.Url(new() { });

        Assert.True(TestBase.UrisEqual(new Uri("https://demo.firefly-iii.org/api/v1/tags"), url));
    }
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        TagCreateParams parameters = new()
        {
            Tag = "expensive",
            XTraceID = "40c71bbb-c676-4f24-83cf-cc725d7d7a00",
        };
    ...
    public void CopyConstructor_Works()
    {
        ...
        TagCreateParams copied = new(parameters);
