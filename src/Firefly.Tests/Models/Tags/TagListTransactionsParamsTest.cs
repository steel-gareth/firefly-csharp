...
public class TagListTransactionsParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new TagListTransactionsParams
        {
            Tag = "groceries",
            End = "2026-04-30",
            Limit = 10,
    ...
    {
        var parameters = new TagListTransactionsParams { Tag = "groceries" };
    ...
    {
        TagListTransactionsParams parameters = new()
        {
            Tag = "groceries",
            End = "2026-04-30",
            Limit = 10,
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://demo.firefly-iii.org/api/v1/tags/groceries/transactions?end=2026-04-30&limit=10&page=1&start=2026-04-01&type=all"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        TagListTransactionsParams copied = new(parameters);
