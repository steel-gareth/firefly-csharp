...
public class CurrencyListTransactionsParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new CurrencyListTransactionsParams
        {
            Code = "USD",
            End = "2026-04-30",
            Limit = 10,
    ...
    {
        var parameters = new CurrencyListTransactionsParams { Code = "USD" };
    ...
    {
        CurrencyListTransactionsParams parameters = new()
        {
            Code = "USD",
            End = "2026-04-30",
            Limit = 10,
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://demo.firefly-iii.org/api/v1/currencies/USD/transactions?end=2026-04-30&limit=10&page=1&start=2026-04-01&type=all"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CurrencyListTransactionsParams copied = new(parameters);
