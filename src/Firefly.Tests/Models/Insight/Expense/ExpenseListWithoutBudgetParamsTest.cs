...
public class ExpenseListWithoutBudgetParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new ExpenseListWithoutBudgetParams
        {
            End = "2019-12-27",
            Start = "2019-12-27",
            Accounts = [1, 2, 3],
    ...
    {
        ExpenseListWithoutBudgetParams parameters = new()
        {
            End = "2019-12-27",
            Start = "2019-12-27",
            Accounts = [1, 2, 3],
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://demo.firefly-iii.org/api/v1/insight/expense/no-budget?end=2019-12-27&start=2019-12-27&accounts=1%2c2%2c3"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ExpenseListWithoutBudgetParams copied = new(parameters);
