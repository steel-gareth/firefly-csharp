...
using Firefly.Models.Insight.Income;

namespace Firefly.Tests.Models.Insight.Income;

public class IncomeListByCategoryParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new IncomeListByCategoryParams
        {
            End = "2019-12-27",
            Start = "2019-12-27",
            Accounts = [1, 2, 3],
        ...
        List<long> expectedCategories = [1, 2, 3];
    ...
    public void OptionalNonNullableParamsUnsetAreNotSet_Works()
    {
        ...
        Assert.False(parameters.RawQueryData.ContainsKey("categories"));
    ...
    {
        IncomeListByCategoryParams parameters = new()
        {
            End = "2019-12-27",
            Start = "2019-12-27",
            Accounts = [1, 2, 3],
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://demo.firefly-iii.org/api/v1/insight/income/category?end=2019-12-27&start=2019-12-27&accounts=1%2c2%2c3&categories=1%2c2%2c3"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        IncomeListByCategoryParams copied = new(parameters);
