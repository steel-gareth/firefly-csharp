...
public class IncomeListWithoutCategoryParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new IncomeListWithoutCategoryParams
        {
            End = "2019-12-27",
            Start = "2019-12-27",
            Accounts = [1, 2, 3],
    ...
    {
        IncomeListWithoutCategoryParams parameters = new()
        {
            End = "2019-12-27",
            Start = "2019-12-27",
            Accounts = [1, 2, 3],
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://demo.firefly-iii.org/api/v1/insight/income/no-category?end=2019-12-27&start=2019-12-27&accounts=1%2c2%2c3"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        IncomeListWithoutCategoryParams copied = new(parameters);
