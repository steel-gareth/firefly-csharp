...
public class RuleGroupListAllResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new RuleGroupListAllResponse
        {
            Data =
            [
                new()
        ...
        List<RuleGroupRead> expectedData =
        [
            new()
            {
                ID = "2",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<RuleGroupListAllResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        RuleGroupListAllResponse copied = new(model);
