...
public class BillListParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new BillListParams
        {
            End = "2026-04-01",
            Limit = 10,
            Page = 1,
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://demo.firefly-iii.org/api/v1/bills?end=2026-04-01&limit=10&page=1&start=2026-04-01"
                ),
                url
            )
        );
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        BillListParams parameters = new() { XTraceID = "40c71bbb-c676-4f24-83cf-cc725d7d7a00" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BillListParams copied = new(parameters);
