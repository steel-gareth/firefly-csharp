...
public class CategoryListTransactionsParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new CategoryListTransactionsParams
        {
            ID = "123",
            End = "2026-04-30",
            Limit = 10,
    ...
    {
        var parameters = new CategoryListTransactionsParams { ID = "123" };
    ...
    {
        CategoryListTransactionsParams parameters = new()
        {
            ID = "123",
            End = "2026-04-30",
            Limit = 10,
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://demo.firefly-iii.org/api/v1/categories/123/transactions?end=2026-04-30&limit=10&page=1&start=2026-04-01&type=all"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CategoryListTransactionsParams copied = new(parameters);
