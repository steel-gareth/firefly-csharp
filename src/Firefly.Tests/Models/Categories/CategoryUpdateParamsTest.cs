...
public class CategoryUpdateParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new CategoryUpdateParams
        {
            ID = "123",
            Name = "Lunch",
    ...
    {
        CategoryUpdateParams parameters = new() { ID = "123", Name = "Lunch" };
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        CategoryUpdateParams parameters = new()
        {
            ID = "123",
            Name = "Lunch",
            XTraceID = "40c71bbb-c676-4f24-83cf-cc725d7d7a00",
    ...
    public void CopyConstructor_Works()
    {
        ...
        CategoryUpdateParams copied = new(parameters);
