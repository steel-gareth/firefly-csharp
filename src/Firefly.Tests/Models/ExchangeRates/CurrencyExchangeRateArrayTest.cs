...
public class CurrencyExchangeRateArrayTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CurrencyExchangeRateArray
        {
            Data =
            [
                new()
        ...
        List<CurrencyExchangeRateRead> expectedData =
        [
            new()
            {
                ID = "2",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<CurrencyExchangeRateArray>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        CurrencyExchangeRateArray copied = new(model);
