...
public class BudgetListTransactionsParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new BudgetListTransactionsParams
        {
            ID = "123",
            End = "2026-04-30",
            Limit = 10,
    ...
    {
        var parameters = new BudgetListTransactionsParams { ID = "123" };
    ...
    {
        BudgetListTransactionsParams parameters = new()
        {
            ID = "123",
            End = "2026-04-30",
            Limit = 10,
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://demo.firefly-iii.org/api/v1/budgets/123/transactions?end=2026-04-30&limit=10&page=1&start=2026-04-01&type=all"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        BudgetListTransactionsParams copied = new(parameters);
