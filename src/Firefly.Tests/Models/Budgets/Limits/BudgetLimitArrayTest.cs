...
public class BudgetLimitArrayTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BudgetLimitArray
        {
            Data =
            [
                new()
        ...
        List<BudgetLimitRead> expectedData =
        [
            new()
            {
                ID = "2",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BudgetLimitArray>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BudgetLimitArray copied = new(model);
