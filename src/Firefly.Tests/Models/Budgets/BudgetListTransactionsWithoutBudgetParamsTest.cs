...
public class BudgetListTransactionsWithoutBudgetParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new BudgetListTransactionsWithoutBudgetParams
        {
            End = "2026-04-30",
            Limit = 10,
            Page = 1,
    ...
    {
        BudgetListTransactionsWithoutBudgetParams parameters = new()
        {
            End = "2026-04-30",
            Limit = 10,
            Page = 1,
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://demo.firefly-iii.org/api/v1/budgets/transactions-without-budget?end=2026-04-30&limit=10&page=1&start=2026-04-01"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        BudgetListTransactionsWithoutBudgetParams copied = new(parameters);
