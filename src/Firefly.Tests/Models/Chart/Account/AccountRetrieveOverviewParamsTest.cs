...
namespace Firefly.Tests.Models.Chart.Account;

public class AccountRetrieveOverviewParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new AccountRetrieveOverviewParams
        {
            End = "2019-12-27",
            Start = "2019-12-27",
            Period = Period.V1M,
    ...
    {
        AccountRetrieveOverviewParams parameters = new()
        {
            End = "2019-12-27",
            Start = "2019-12-27",
            Period = Period.V1M,
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://demo.firefly-iii.org/api/v1/chart/account/overview?end=2019-12-27&start=2019-12-27&period=1M&preselected=all"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        AccountRetrieveOverviewParams copied = new(parameters);
