...
public class AutocompleteListTransactionsWithIDResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new AutocompleteListTransactionsWithIDResponse
        {
            ID = "2",
        ...
        string expectedID = "2";
        string expectedDescription = "#12: Transaction";
        string expectedName = "#12: Transaction";
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<AutocompleteListTransactionsWithIDResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        AutocompleteListTransactionsWithIDResponse copied = new(model);
